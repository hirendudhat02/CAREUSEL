...
export default class CometChatGroupDetails extends React.Component {
  ...
  deleteConversations = conversation => {
    this.setState({ modalOpen: false });
    let conversationWith = this.props.item?.guid
  ...
  render() {
    ...
    let options = (
      <View style={style.fullWidth}>
        <Text style={[style.sectionHeaderStyle, { color: theme.color.helpText }]}>
          Options :
        </Text>
        <View style={style.listItemContainer}>
          {leaveGroupBtn}
    ...
    let avatar = (
      <View style={style.avatarStyle}>
        <CometChatAvatar
          ...
          borderWidth={1}
          image={{ uri: this.props.item.icon }}
                  ...
                  <View style={style.reactionDetailsContainer}>
                    <GroupDetailContext.Provider
                      ...
                      <View
                        ...
                        <Text style={style.headerTitleStyle}>Shared Media</Text>
                      </View>
                      ...
                      >
                        <Image
                          ...
                          resizeMode="contain"
                        />
                        <Text style={style.actionsText}>Delete Group</Text>
                      </TouchableOpacity>
