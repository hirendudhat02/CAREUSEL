...
import {ConnectionBadgeResponse} from '../Action/ConnectionBadgeAction';
import {loaderAction} from '../Action/LoaderAction';

export function* ConnectionBadgeSaga(action) {
  ...
  try {
    ...
    if (responseJson.status === 'success') {
      yield put(ConnectionBadgeResponse(responseJson));
